"""
Django settings for sweet_tooth_1 project.
...
ROOT_URLCONF = 'sweet_tooth_1.urls'
...
WSGI_APPLICATION = 'sweet_tooth_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sweet_tooth_1 API",
    "DESCRIPTION": "API documentation for sweet_tooth_1 App",
    "VERSION": "v1",
}
